...
1.  Composition Metrics: These metrics describe *what* is present in the landscape in terms of the variety and abundance of different patch types, without explicitly considering their spatial arrangement [@símová2012]. They tell us about the components of the landscape, but not how those components are arranged. Examples include:
